...
public class SpineRotate : MonoBehaviour
{
    ...
    //        rotateX = playerTransform.rotation.x - transform.rotation.x;
    //        rotateY = playerTransform.rotation.y - transform.rotation.y;
    //        rotateZ = playerTransform.rotation.z - transform.rotation.z;
